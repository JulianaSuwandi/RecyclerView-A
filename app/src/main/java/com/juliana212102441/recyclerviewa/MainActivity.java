package com.juliana212102441.recyclerviewa;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nm = new NegaraModel();
        nm.setNama("Slovenia");
        nm.setDeskripsi("Slovenia, resminya Republik Slovenia, adalah sebuah negara pesisir sub-Alpen di Eropa Tengah. Slovenia berbatasan dengan Italia di barat, Austria di utara, Hungaria di timurlaut, Kroasia di tenggara, dan Laut Adriatik di baratdaya");
